...
from PyQt5.QtWidgets import (
    ...
    QPushButton, QLabel, QButtonGroup, QLineEdit, QTextEdit, QInputDialog, QFormLayout, QListWidget)
...
# Функционал приожения

# Работа с текстом замтеки

def add_note():
    note_name, ok = QInputDialog.getText(
        notes_win, 'Добавить заметку', 'Название заметок')
    if ok and note_name != "":
...
def show_note():
    # получаем текст из заметки с выделенным названием и отоброжаем его в поле редактирования
